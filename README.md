...
- ![gitcommit](https://github.com/ikmalriyan21/gambar5/blob/master/git%204.png)
...
- ![gitremoteaddorigin](https://github.com/ikmalriyan21/gambar6/blob/master/git%205.png)
## Push (Mengirim perubahan ke server)
- Untuk mengirim perubahan pada local repository ke server gunakan perintah git push.
- Perintah ini akan meminta memasukkan username dan password pada akun github.com
- $ git push -u origin master
- ![gitpushorigin](https://github.com/ikmalriyan21/gambar7/blob/master/git%206.png)
## Clone Repository
